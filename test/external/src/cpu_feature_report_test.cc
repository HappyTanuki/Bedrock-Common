 ...
 */
// clang-format off
constexpr auto kAllFeatures =
    std::to_array<std::pair<CpuFeature, std::string_view>>({
    {CpuFeature::kFPU,                  "FPU"},
    {CpuFeature::kVME,                  "VME"},
    {CpuFeature::kDE,                   "DE"},
    {CpuFeature::kPSE,                  "PSE"},
    ...
    {CpuFeature::kDsCpl,               "DS_CPL"},
    {CpuFeature::kVMX,                  "VMX"},
    {CpuFeature::kSMX,                  "SMX"},
    {CpuFeature::kEST,                  "EST"},
    {CpuFeature::kTM2,                  "TM2"},
    {CpuFeature::kSSSE3,                "SSSE3"},
    {CpuFeature::kCnxtId,              "CNXT_ID"},
    ...
    {CpuFeature::kTscDeadline,         "TSC_DEADLINE"},
    ...
    {CpuFeature::kADX,                  "ADX"},
    {CpuFeature::kAvX512Ifma,          "AVX512_IFMA"},
    ...
    {CpuFeature::kAvX512Vbmi,          "AVX512_VBMI"},
    {CpuFeature::kWAITPKG,              "WAITPKG"},
    {CpuFeature::kAvX512VbmI2,         "AVX512_VBMI2"},
    {CpuFeature::kGFNI,                 "GFNI"},
    {CpuFeature::kVAES,                 "VAES"},
    {CpuFeature::kVPCLMULQDQ,           "VPCLMULQDQ"},
    {CpuFeature::kAvX512Vnni,          "AVX512_VNNI"},
    {CpuFeature::kAvX512Bitalg,        "AVX512_BITALG"},
    {CpuFeature::kAvX512Vpopcntdq,     "AVX512_VPOPCNTDQ"},
    ...
    {CpuFeature::kAvX5124Vnniw,        "AVX512_4VNNIW"},
    {CpuFeature::kAvX5124Fmaps,        "AVX512_4FMAPS"},
    {CpuFeature::kFSRM,                 "FSRM"},
    {CpuFeature::kUINTR,                "UINTR"},
    {CpuFeature::kAvX512VP2Intersect,  "AVX512_VP2INTERSECT"},
    {CpuFeature::kSERIALIZE,            "SERIALIZE"},
    {CpuFeature::kAmxBF16,             "AMX_BF16"},
    {CpuFeature::kAvX512FP16,          "AVX512_FP16"},
    {CpuFeature::kAmxTile,             "AMX_TILE"},
    {CpuFeature::kAmxInT8,             "AMX_INT8"},
    {CpuFeature::kLahfLm,              "LAHF_LM"},
    ...
    {CpuFeature::kSM3,                  "SM3"},
    {CpuFeature::kSM4,                  "SM4"},
    {CpuFeature::kAvxVnni,             "AVX_VNNI"},
    {CpuFeature::kAvX512BF16,          "AVX512_BF16"},
    {CpuFeature::kCMPCCXADD,            "CMPCCXADD"},
    {CpuFeature::kAmxFP16,             "AMX_FP16"},
    {CpuFeature::kAvxIfma,             "AVX_IFMA"},
    ...
    {CpuFeature::kAvX512Bmm,           "AVX512_BMM"},
    {CpuFeature::kFP,                   "FP"},
    ...
    {CpuFeature::kSME,                  "SME"},
    {CpuFeature::kSmeI16I64,           "SME_I16I64"},
    {CpuFeature::kSmeF64F64,           "SME_F64F64"},
    {CpuFeature::kSmeI8I32,            "SME_I8I32"},
    {CpuFeature::kSmeF16F32,           "SME_F16F32"},
    {CpuFeature::kSmeB16F32,           "SME_B16F32"},
    {CpuFeature::kSmeF32F32,           "SME_F32F32"},
    {CpuFeature::kSmeFA64,             "SME_FA64"},
...
TEST(CpuFeatureReport, EnumeratesAllKnownFeatures) {
  const auto reg = bedrock::intrinsic::GetCPUFeatures();

  std::cout << "Supported cpu instruction features:" << "\n";
  ...
  EXPECT_LE(supported, std::size(kAllFeatures));
}
